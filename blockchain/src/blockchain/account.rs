...
/// Represents an account on the blockchain.<br/>
/// This is basically the primary part of the "world state" of the blockchain.<br/>
...
/// which could be used to represent different roles within the system.<br/>
